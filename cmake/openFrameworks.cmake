...
set(OF_CORE_HEADERS ${HEADER_OF_0} ${HEADER_OF_1} ${HEADER_OF_2} ${HEADER_OF_3} ${HEADER_OF_4} ${HEADER_OF_5} ${HEADER_OF_6} ${HEADER_OF_7} ${HEADER_OF_8} ${HEADER_OF_9} ${HEADER_OF_10} ${HEADER_OF_11} ${HEADER_POCO} ${HEADER_FREETYPE} ${HEADER_FREETYPE2} ${HEADER_FMODEX} ${HEADER_GLEW} ${HEADER_FREEIMAGE} ${HEADER_TESS2} ${HEADER_CAIRO} ${HEADER_RTAUDIO} ${HEADER_GLFW} ${HEADER_SSL} ${HEADER_UTF8})
# ========================================================

# ===================== Libs =====================
set(LIB_FMODEX ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/fmodex/lib/osx/libfmodex.dylib)
set(LIB_GLFW ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/glfw/lib/osx/glfw3.a)
set(LIB_FREEIMAGE ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/FreeImage/lib/osx/freeimage.a)
set(LIB_FREETYPE ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/freetype/lib/osx/freetype.a)
set(LIB_GLEW ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/glew/lib/osx/glew.a)
set(LIB_POCO_1 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoCrypto.a)
set(LIB_POCO_2 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoData.a)
#set(LIB_POCO_3 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoDataODBC.a)
set(LIB_POCO_4 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoDataSQLite.a)
set(LIB_POCO_5 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoFoundation.a)
set(LIB_POCO_6 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoNet.a)
set(LIB_POCO_7 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoNetSSL.a)
set(LIB_POCO_8 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoUtil.a)
set(LIB_POCO_9 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoXML.a)
set(LIB_POCO_10 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/poco/lib/osx/PocoZip.a)
set(LIB_RTAUDIO ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/rtAudio/lib/osx/rtAudio.a)
set(LIB_TESS ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/tess2/lib/osx/tess2.a)
set(LIB_CAIRO1 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/cairo/lib/osx/cairo-script-interpreter.a)
set(LIB_CAIRO2 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/cairo/lib/osx/cairo.a)
set(LIB_CAIRO3 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/cairo/lib/osx/pixman-1.a)
set(LIB_OPENSSL1 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/openssl/lib/osx/crypto.a)
set(LIB_OPENSSL2 ${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/openssl/lib/osx/ssl.a)
...
set_target_properties(static PROPERTIES LINK_FLAGS "-std=c++11 -stdlib=libc++ -arch x86_64 -F'${OF_DIRECTORY}/libs/glut/lib/osx/' -F${FRAMEWORKS_DIR}")
...
set_target_properties(of_shared PROPERTIES LINK_FLAGS "-std=c++11 -stdlib=libc++ -arch x86_64 -F'${CMAKE_SOURCE_DIR}/${OF_DIRECTORY}/libs/glut/lib/osx/' -F${FRAMEWORKS_DIR}")
set_target_properties(of_shared PROPERTIES LINK_FLAGS "-std=c++11 -stdlib=libc++ -arch x86_64 -F${FRAMEWORKS_DIR}")
